...
\item \textcolor{darkblue}{\large Event/subevent processing engine:} \uncover<7->{Columnar manipulation of nested structures is missing from both the data science \underline{\it and} HEP software stacks; significant performance gains.}
\end{itemize}
\end{columns}
\end{frame}
